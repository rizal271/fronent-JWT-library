...
import {
    getdetailBuku
} from "../Global/redux/actions/buku";
    ...
    render() {
        ...
        return (
            <div className="container">
                <div className="jumbotron" style={{backgroundImage: `url(`+list.gbr+')'}}>
                    <div className="row">
                    ...
                    <div className="card cardBook" style={{maxWidth: '15rem'}}>
                        <img src={list.gbr} style={{height:"299px"}} className="card-img-top" alt="..." />
                    </div>                  
                </div>
                <div className="row">
